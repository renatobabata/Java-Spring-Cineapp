      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">         
            <img src="${urlPublic}/imagens/slide1.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlPublic}/imagens/slide2.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlPublic}/imagens/slide3.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlPublic}/imagens/slide4.jpg" alt="Slide" title="Some text" >
          </div>
        </div>
      ...
      <div class="container marketing">
		...
		<c:forEach items="${filmes}" var="filme">
          <div class="col-xs-12 col-sm-6 col-md-3">
            <img class="img-rounded" src="${urlPublic}/imagens/${filme.imagem}" alt="Generic placeholder image" width="150" height="200">
            <h4>${filme.titulo}</h4>
            <h4>
              <span class="label label-default">${filme.classificacao }</span>
